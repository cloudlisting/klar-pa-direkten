...
const en: Dict = {
  ...
  "nav.admin": "Admin",
  "nav.logout": "Log out",
  "hero.badge": "🇸🇪 Sweden's marketplace for services",
  "hero.title1": "Get things done.",
  "hero.title2": "Fast & easy.",
  "hero.subtitle": "Find trusted local taskers in your area, or earn money helping others with everyday tasks.",
